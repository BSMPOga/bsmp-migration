...
{
    public $company_id = 258;
    public $new_company = '6a8a17a3-f895-4964-b10a-1eac52b88f8e'; //'efe25ab9-4f0a-47b5-aa4b-1438f27d97ba';
    ...
    {
        // 5113
        $payments = DB::table('payments')->where('company_id', $this->company_id)->where('id', '>', 34544)->get();
        // return $payments;
